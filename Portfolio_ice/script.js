...
const projects = [
  {
    id: "p1",
    title: "เข้ารวมถวายพระพรชัยมงคล",
    cover: "a1.jfif",
    desc: "เป็นกิจกรรมถวายพระพรที่ได้เข้ารวม",
    category: "website",
  ...
  {
    id: "p2",
    title: "เข้ารวมกิจกรรมแอดไวซ์ ไอที",
    cover: "a2.jfif",
    desc: "ที่เขามาสอนและให้ความรู้ของการสอนประกอบคอมพิวเตอร์เบื้องตัน",
    category: "ui",
    tags: ["UI","Prototype"],
  ...
  },
  {
    ...
    title: "ตัดต่อวิดีโอ",
    cover: "a5.jfif",
    desc: "ยังเป็นวิดีโอที่ยังไม่เสร็จแล้วยังไม่สวยแต่มันเป็นงานที่ชอบมาก",
    category: "tool",
